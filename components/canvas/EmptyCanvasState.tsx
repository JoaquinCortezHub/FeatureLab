...
export const EmptyCanvasState = ({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center">
      ...
      >
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-primary-100 to-secondary-100 dark:from-primary-900/30 dark:to-secondary-900/30">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <button
              ...
              className="flex items-center gap-1 font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
            >
        ...
        <div className="mt-12 grid grid-cols-3 gap-4">
          {[
            ...
            >
              <step.icon className="mb-2 h-6 w-6 text-gray-400" />
